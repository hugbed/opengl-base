//
// Created by Hugo Bedard on 2017-04-04.
//

#ifndef UNTITLED1_HOLA_H
#define UNTITLED1_HOLA_H

#endif //UNTITLED1_HOLA_H
#include <iostream>
...
int main()
{
  ...
  Shader shader((FileIO::getCurrentDirectory()+"/shaders/points.vs").c_str(),
    (FileIO::getCurrentDirectory()+"/shaders/points.fs").c_str());
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    /////////////////////////////////////////////////////////////////////
    // Update transforms
    glm::mat4 projection = glm::perspective(verticalFieldOfView, (float) windowWidth/(float) windowHeight, -nearPlaneZ,
      -farPlaneZ);
